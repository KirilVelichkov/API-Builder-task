...
module.exports = {
	...
	admin: {
		...
		validEmails: ["kvelichkow@abv.bg"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [641414926661169]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: '3LbwTw7fSDi8y6va5uUBS+uRPbzW7HIOou7+iixKosY=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'bRMAPKRWA+yHTj1OqUiEanQtkU/WhEEcIkYUDtc2CLDOtMjlahBu34b+enR4hOFeRQWd/iqFRz0kLqTZ7AqC3Q==',
		secret: 'a5hHAF4zCRdPKyi7d21dtKPkULkvQJEa', // should be a large unguessable string
	...
	cookieSecret: 'TM8k41qJ1tXPPNBmGA+0MbkwDX9IEPg7',
